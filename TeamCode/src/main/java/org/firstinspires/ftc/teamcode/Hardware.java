...
public class Hardware {
    ...
    public List<DcMotor> baseArm = new ArrayList<>(2); // Doing the same things to them
    public List<Servo> extArm = new ArrayList<>(2); // Same as above
    ...
    public Hardware(HardwareMap hwMap) {
        ...
        baseArm.set(0, hwMap.dcMotor.get("base_arm_left"));
        baseArm.set(1, hwMap.dcMotor.get("base_arm_right"));
        ...
        extArm.set(0, hwMap.servo.get("ext_arm_left"));
        extArm.set(1, hwMap.servo.get("ext_arm_right"));
